...
Since the rank does not infer any sort of quality or usefulness score from the system, there is no way of identifying the top $n$ documents from each topic from each system, making it difficult to pool them effectively.
