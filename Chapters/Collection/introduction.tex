...
To do so, we create a collection of 120 million tweets, and by implementing two existing event detection approaches, we extract a set of candidate events and their associated tweets.
